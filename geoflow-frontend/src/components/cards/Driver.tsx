...
export default function Driver(props: Props) {
  return (
        ...
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3 w-full h-fit">
                ...
                <div className="flex h-10 flex-col gap-1">
                    <p className="text-xs text-[#737982] font-semibold">Motorista</p>
                    <p className="text-md font-semibold leading-none">Carlos Silva</p>
                </div>
            </div>
            <div className="flex items-center gap-2 w-full h-fit">
                <PhoneIcon />
                <p className="text-sm text-[#FFFFFF] font-regular">+55 11 98765-4321</p>
            </div>
        </div>
    </div>
  )
